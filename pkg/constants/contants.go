...
const (
	ImageModePrivate ImageMode = "Private"
	ImageModePublic  ImageMode = "Public"
)
...
const (
	DepartmentNameKey    MessageLangKey = "name"
	DepartmentDescKey    MessageLangKey = "description"
	DepartmentNoteKey    MessageLangKey = "note"
